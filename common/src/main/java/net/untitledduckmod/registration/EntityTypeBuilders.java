...
public class EntityTypeBuilders {
    ...
    public final static Supplier<EntityType<DuckEggEntity>> GOOSE_EGG = () -> (EntityType<DuckEggEntity>) build("goose_egg", EntityType.Builder.<DuckEggEntity>create(DuckEggEntity::new, SpawnGroup.MISC).setDimensions(0.25F, 0.25F).maxTrackingRange(4).trackingTickInterval(10));
