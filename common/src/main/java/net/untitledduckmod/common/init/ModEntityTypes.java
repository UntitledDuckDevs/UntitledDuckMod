...
public class ModEntityTypes {
    ...
    static {
        DUCK = RegistryHelper.registerEntity("duck", () -> EntityType.Builder.create(DuckEntity::new, CustomSpawnGroup.WATERFOWL.spawnGroup).dimensions(0.6f, 0.6f).maxTrackingRange(10).build(DuckMod.stringID("duck")));
        ...
        GOOSE = RegistryHelper.registerEntity("goose", () -> EntityType.Builder.create(GooseEntity::new, CustomSpawnGroup.WATERFOWL.spawnGroup).dimensions(0.7f, 1.2f).maxTrackingRange(10).build(DuckMod.stringID("goose")));
